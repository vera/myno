...
device_dict_mup = { 'TEST-DEVICE-MUP': ('TestDevices',
                    {'rpcs': {
                      ...
                      'funcPubUpdateKeyU': ('Perform rollover of update server key', 'input_07_Signature', 'hexBinary', [['input_01_AppId', 'string'], ['input_02_Version', 'int'], ['input_03_NewKeyInfo', 'hexBinary'], ['input_04_NewKey', 'hexBinary'], ['input_05_DeviceNonce', 'int'], ['input_06_KeyInfo', 'hexBinary'], ['input_07_Signature', 'hexBinary']], 'yang/update/rollover/TEST-DEVICE-MUP'),
                      'funcPubUpdateKeyV': ('Perform rollover of update server key', 'input_09_OuterSignature', 'hexBinary', [['input_01_AppId', 'string'], ['input_02_Version', 'int'], ['input_03_NewKeyInfo', 'hexBinary'], ['input_04_NewKey', 'hexBinary'], ['input_05_InnerKeyInfo', 'hexBinary'], ['input_06_InnerSignature', 'hexBinary'], ['input_07_DeviceNonce', 'int'], ['input_08_OuterKeyInfo', 'hexBinary'], ['input_09_OuterSignature', 'hexBinary']], 'yang/update/rollover/TEST-DEVICE-MUP')
                    }, 'sensors': {
